...
class AndroidDebugBridge( object ):
    ...
    # 安装app
    def install_apk(self, apkFile):
        result = self.call_adb( "install -r %s" % (apkFile) )
        return result

    # 卸载app
    def uninstall_apk(self, packageName):
        return self.call_adb( "uninstall %s" % (packageName) )
        return reuslt
...
if __name__ == '__main__':
    ...
    # reuslt = adb.attached_devices()
    # print( reuslt )

    #a = adb.open_app( "cn.zhimawu", "cn.zhimawu.SplashActivity" )
    #print( a )

    adb.install_apk("../app/1.apk")
   # adb.uninstall_apk( "cn.zhimawu" )
