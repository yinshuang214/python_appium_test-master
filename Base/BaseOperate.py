...
class OperateElement:
    ...
    def findElement(self, mOperate):
        ...
        try:
            ...
            if type( mOperate ) == dict:  # 单检查点
                ...
                WebDriverWait( self.driver, t ).until( lambda x: self.elements_by( mOperate ) )  # 显示等待操作元素是否存在
                return {"result": True}
    ...
    # 向下滑动 swipe start_x: 200, start_y: 200, end_x: 200, end_y: 400, duration: 2000 从200滑动到400
    ...
    def elements_by(self, mOperate):
        ...
        elements = {
            ...
            be.find_elements_by_xpath: lambda: self.driver.find_elements_by_xpath( mOperate["element_info"] )[
                mOperate['index']],
            be.find_element_by_name: lambda: self.driver.find_element_by_name( mOperate['element_info'] ),
            be.find_elements_by_name: lambda: self.driver.find_elements_by_name( mOperate['element_info'] )[
                mOperate['index']],
            ...
            be.find_element_by_ios_predicate: lambda: self.driver.find_element_by_ios_predicate(
                mOperate["element_info"] ),
            be.find_elements_by_ios_predicate: lambda:
            self.driver.find_elements_by_ios_predicate( mOperate["element_info"] )[mOperate['index']],
